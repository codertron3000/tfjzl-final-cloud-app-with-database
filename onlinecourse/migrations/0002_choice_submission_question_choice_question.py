# Generated by Django 4.2.3 on 2024-04-02 01:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_question', to='onlinecourse.course')),
            ],
        ),
        migrations.AddField(
            model_name='choice',
